...
**Что дальше.** Мы закрыли базовую гигиену. Следующий барьер — автоматизация после импорта: чтобы PR не ждал ручного подтверждения часами, а мёржился сразу после зелёного Docs CI.
