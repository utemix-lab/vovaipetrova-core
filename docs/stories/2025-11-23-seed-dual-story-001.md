...
last_edited_time: ""
author_block: |
  Автор: Черновая заготовка — напишите от первого лица короткий абзац, который задаёт тон истории.
  Это placeholder, без PII, для дальнейшей ручной доработки.
