...
**Что получилось.** Скрипт fix-links обрабатывает все Markdown-файлы, находит ссылки в формате Markdown, сопоставляет их с файлами через slug, заменяет на нормализованные пути. Исправление интегрировано в workflow импорта и CI, запускается автоматически после normalize.
