...
Если хотите, могу также вынести отдельный файл `docs/stories/WARM_START.md` с этими инструкциями и ссылками, или добавить заметки в `.github/` (PR template). Скажите, что предпочитаете — добавлю и запушу.
