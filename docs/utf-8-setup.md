...
slug: utf-8-setup
summary: Руководство по настройке UTF-8 кодировки в редакторах и Git для правильной работы с русским текстом.
status: ready
tags:
  - Документация
  - Инструменты
...
Все файлы в проекте должны быть в кодировке UTF-8 без BOM. Это обеспечивает правильное отображение русского текста во всех редакторах и на GitHub.
...
**Перед коммитом:**
- Убедитесь, что файлы в кодировке UTF-8 (проверьте в статус-баре редактора)
- Откройте файл на GitHub для проверки корректного отображения
